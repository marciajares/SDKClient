...
@Document(collection = "request_message")
public class RequestMessageModel implements IDigitalObject, ITrain, IMetada, IMongo{
	...
	@XStreamAlias("train")
	private TrainMessageModel trainDefinition = new TrainMessageModel();

	public TrainMessageModel getTrainDefinition() {
		return trainDefinition;
	}

	public void setTrainDefinition(TrainMessageModel trainDefinition) {
		this.trainDefinition = trainDefinition;
	}
