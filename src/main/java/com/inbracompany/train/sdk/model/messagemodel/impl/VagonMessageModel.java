...
@Repository
@XStreamAlias("vagons")
@Document(collection = "vagon_message")
public class VagonMessageModel implements IDigitalObject, ITrain, IMetada, IMongo{
	...
	private List<ResourceMessageModel> resourcesDefinition = new ArrayList<ResourceMessageModel>();


	public List<ResourceMessageModel> getResourcesDefinition() {
		return resourcesDefinition;
	}
	public void setResourcesDefinition(List<ResourceMessageModel> resourcesDefinition) {
